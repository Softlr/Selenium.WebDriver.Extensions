namespace Selenium.WebDriver.Extensions
{
    ...
    /// </summary>
    /// <remarks>
    /// This class shadows all of the static members of the <see cref="OpenQA.Selenium.By"/>. The reason for that is to replace
    ...
    public class By : SeleniumBy
    {
        ...
        /// <returns>A <see cref="OpenQA.Selenium.By"/> object the driver can use to find the elements.</returns>
        public static new SeleniumBy CssSelector(string cssSelectorToFind) => SeleniumBy.CssSelector(cssSelectorToFind);
        ...
        /// <summary>
        /// Gets a mechanism to find elements by an XPath query. When searching within a <see cref="IWebElement"/> using xpath be
        /// aware that <see cref="IWebDriver"/> follows standard conventions: a search prefixed with <c>"//"</c> will search the
        /// entire document, not just the children of this current node. Use <c>".//"</c> to limit your search to the children of
        ///  this <see cref="IWebElement"/>.
        /// </summary>
