namespace Selenium.WebDriver.Extensions
{
    ...
    internal static class Suppress
    {
        ...
        {
            public const string ASYNC_AWAIT_IDENTIFIER =
                "AsyncAwaitIdentifier:async and await should not be used as identifiers";

            public const string OBSOLETE = "obsolete:params should be used instead of varargs";
